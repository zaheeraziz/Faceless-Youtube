...
OUT_DIR = os.path.join(ROOT, "frames_v3")
VIDEO_SILENT = os.path.join(ROOT, "scene1_lost_agent_probe_v3.mp4")
AUDIO = os.path.join(ROOT, "scene1_temp_voice_v3.aiff")
VIDEO_VOICE = os.path.join(ROOT, "scene1_lost_agent_probe_v3_with_voice.mp4")
...
def draw_prompt(draw, t):
    ...
    text_center(draw, (540, 166), "Smart?", FONT_SMALL, (230, 250, 255))
...
def render_frame(i):
    ...
    if reveal > 0:
        ...
        text_center(draw, (540, 580), "Graph Route", FONT_SMALL, (160, 225, 255, int(120 * reveal)))
    ...
    if t > 0.53:
        ...
        text_center(draw, (545, 1435), "Skipped Check.", FONT_HERO, (246, 250, 255, int(230 * clamp((t - 0.55) / 0.12))))
    ...
    if t > 0.79:
        ...
        text_center(draw, (540, 1022), "It needs the next step.", FONT_SMALL, (130, 221, 255, int(235 * fade)))
...
subprocess.run(
    [
        ...
        "-r",
        "158",
        "An AI agent can sound smart. But without a usable map, it can still skip the step that matters.",
        "-o",
        AUDIO,
    ],
    check=True,
