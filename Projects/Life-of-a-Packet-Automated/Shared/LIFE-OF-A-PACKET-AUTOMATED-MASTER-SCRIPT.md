# Master Script — The Life of a Packet (Automated)

## Locked Package

Locked from `Projects/Life-of-a-Packet-Automated/Codex/draft-v03.md` after Step 6 owner review (Coverage Desk pipeline, produced by `run-pipeline.sh`, Step 6 revision by Codex for length/acronym/bookend fixes). Title, thumbnail direction, and other packaging decisions are downstream of this spec and not yet made.
